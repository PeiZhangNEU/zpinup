...
if __name__ == '__main__':
    # ddqn
    test('data/ddqn_breakout/dqn_9_policy.pt','Breakout-v0')
    # # dqn
    # test('data/dqn_breakout/dqn_1_policy.pt','Breakout-v0')
    # # dqn2015
    # test('data/dqn2015_breakout/dqn_2_policy.pt','Breakout-v0')