...
import csv
from alogos.dqn.dqn2015 import *
...
def train(env_fn, policy=core.MLPpolicy, ac_kwargs=dict(), seed=0, 
          ...
          pi_lr=1e-3,  batch_size=64, delay_up=0.995,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='dqn2015_lunar')
    args = parser.parse_args()

    # 执行训练过程
    train(lambda : gym.make(args.env), policy=core.MLPpolicy,
