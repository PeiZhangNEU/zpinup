...
def train(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        agent = td3(env_fn, actor_critic=actor_critic, ac_kwargs=ac_kwargs, 
                     ...
                     target_noise=target_noise, noise_clip=noise_clip, policy_delay=policy_delay,
                     device=device)
        env = env_fn()
        ...
        for t in range(total_steps): 
            ...
            if (t+1) % steps_per_epoch == 0:
                ...
                if (epoch % save_freq == 0) or (epoch == epochs):
                    torch.save(agent.ac, model_dir + '/td3_' + str(epoch) + '_ac.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='td3_hopper')
